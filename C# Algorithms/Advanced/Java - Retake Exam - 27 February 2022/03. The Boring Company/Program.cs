namespace _03._The_Boring_Company
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var MST = MSTKruskal(graph, connectedDistricts);
        ...
        private static List<Edge> MSTKruskal(Graph graph, int availableConnections)        //Minimum Spanning Tree - Kruskal’s algorithm 
        {
